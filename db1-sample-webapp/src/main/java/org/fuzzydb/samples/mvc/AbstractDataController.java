...
import com.wwm.attrs.db1.AttributeDefinitionService;
import com.wwm.db.query.Result;
import com.wwm.db1.spring.repository.AttributeMatchQuery;
import com.wwm.db1.spring.repository.FuzzyRepository;
import com.wwm.db1.spring.repository.SubjectMatchQuery;
...
public abstract class AbstractDataController<ENTITY> {
	...
	public void search(
		...
		ENTITY idealMatch = StringUtils.hasText(ref) ? getRepo().findOne(ref) : getInitialSearchEntity();
	...
	abstract protected ENTITY getInitialSearchEntity();
